...
export const DownIcon: React.FC<Props> = ({ width = '12px', height = '12px', className }) => (
    <svg
...
export const NotMessagesIcon: React.FC<Props> = ({ width = '96px', height = '96px', className }) => (
    <svg
        aria-label=""
        fill="currentColor"
        role="img"
...
export const CallIcon: React.FC<Props> = ({ width = '24px', height = '24px', className }) => (
    <svg
...
export const VideoCallIcon: React.FC<Props> = ({ width = '24px', height = '24px', className }) => (
    <svg
...
export const InfoIcon: React.FC<Props> = ({ width = '24px', height = '24px', className }) => (
    <svg
...
export const ImageIcon: React.FC<Props> = ({ width = '24px', height = '24px', className }) => (
    <svg
...
export const MicrophoneIcon: React.FC<Props> = ({ width = '24px', height = '24px', className }) => (
    <svg
...
export const EmojiIcon: React.FC<Props> = ({ width = '24px', height = '24px', className }) => (
    <svg
...
export const SendFlyIcon: React.FC<Props> = ({ width = '24px', height = '24px', className }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        className={className}
        width={width}
