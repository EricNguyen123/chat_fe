    ...
    <div className={cx('wrapper')}>
      ...
      <form className={cx('form')} onSubmit={formik.handleSubmit}>
        <div className={cx('title-box')}>
          <p className={cx('title')}>{t("form.titleLogin")}</p>
        </div>
        ...
        <div className={cx('box-input')}>
          ...
          />
          <svg fill="none" viewBox="0 0 24 24" height="24" width="24" xmlns="http://www.w3.org/2000/svg" className={cx('icon')}>
        ...
        <div className={cx('footer-box')}>
          <p className="signin">{t("form.msgLogin")} <Link className={cx('link')} to={config.routes.register}>{t("form.linkSignup")}</Link> </p>
        </div>
      </form>
    </div>
  );
