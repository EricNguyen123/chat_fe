...
export default function userReducer(state: PostState = initState, action: Action) {
    switch (action.type) {
        case types.GET_POST: {
        ...
        case types.UPDATE_POST_SUCCESS: {
            ...
            return {
                ...
                loading: false,
                post: action.payload || undefined,
                posts: state.posts.map((post: any) => (post.id === action.payload.id ? updatedPost : post)),
            };
        }
        ...
        case types.GET_USER_POSTS_SUCCESS: {
            return {
                ...state,
                loading: false,
                user_posts: action.payload || undefined,
            };
        }
